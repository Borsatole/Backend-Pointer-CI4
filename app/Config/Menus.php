...
return [
    ...
    1 => [
        ...
        ['id' => 4, 'nome' => 'Vistorias', 'rota' => '/vistorias', 'icone' => 'vistorias'],
        ['id' => 5, 'nome' => 'Chamados', 'rota' => '/chamados', 'icone' => 'chamados'],

        ['id' => 6, 'nome' => 'Níveis de Acesso', 'rota' => '/acesso-niveis', 'icone' => 'permissoes'],
    ],
    // Padrão
    2 => [
        ['id' => 1, 'nome' => 'Dashboard', 'rota' => '/', 'icone' => 'dashboard'],
